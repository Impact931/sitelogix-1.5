...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onBack, onNavigateToProjectSetup: _onNavigateToProjectSetup, onNavigateToProjectProfile, onNavigateToRoxy, onNavigateToUserManagement, onNavigateToChangePassword, onNavigateToPayroll, onNavigateToEmployeeManagement }) => {
            ...
            <div className="flex items-center space-x-3">
              {onNavigateToPayroll && (
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:shadow-lg hover:shadow-green/20 transition text-sm font-semibold flex items-center space-x-2"
                >
              ...
              {onNavigateToEmployeeManagement && (
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-blue/20 transition text-sm font-semibold flex items-center space-x-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
